...
<div class="form-group">
    ...
    <div class="form-row">
        <div class="col-md-5">
            <input type="text" name="firstname" value="{{old('firstname')}}" class="input-identity form-control input-big" id="firstname" aria-describedby="" placeholder="Prénom">
        </div>
        <div class="col-md-7">
            <input type="text" name="lastname" value="{{old('lastname')}}" class="input-identity form-control input-big" id="surname" aria-describedby="" placeholder="Nom">
        </div>
    </div>
