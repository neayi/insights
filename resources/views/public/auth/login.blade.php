                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-6 offset-lg-2 bg-white-mobile">
                                <div class="row mb-4">
                                    <div class="col-md-12">
                                        <h4 class="text-dark-green font-weight-bold mt-2">Se connecter</h4>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-10">
                                            <div class="form-group">
                                                ...
                                                <input name="email" type="email" value="{{ old('email') }}" class="form-control" id="email" aria-describedby="emailHelp" placeholder="Votre adresse email">
                                                @if ($errors->has('email'))
