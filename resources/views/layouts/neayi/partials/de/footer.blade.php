...
<li><a href="{{$wikiUrl}}/wiki/%C3%80_propos" title="Über">Über</a></li>
<li><a href="{{$wikiUrl}}/wiki/Partenaires" title="Partner">Partner</a></li>
<li><a href="{{$wikiUrl}}/wiki/Manifeste_de_la_plateforme_Triple_Performance" title="Warum?">Warum?</a></li>
<li><a href="{{$wikiUrl}}/wiki/Comment_fonctionne_la_plateforme" title="Wie funktioniert es?">Wie funktioniert es?</a></li>
<li><a href="#" class="neayi-tour">Führung starten</a> <i class="fas fa-route"></i></li>
</ul>
<p class="footer-title">Gemeinschaft</p>
<ul class="list-unstyled">
<li><a rel="nofollow" class="login-links" href="{{$wikiUrl}}/wiki/Special:Login">Konto erstellen oder anmelden</a></li>
<li><a href="{{$wikiUrl}}/wiki/Help:Bienvenue" title="Beitragen? Hier fängt es an!">Beitragen? Hier fängt es an!</a></li>
<li><a href="https://forum.de.tripleperformance.ag">Auf das Forum zugreifen</a></li>
</ul>
</div>
<div class="col-xl-2 col-lg-6">
<p class="footer-title">Produktionen</p>
<ul class="list-unstyled">
<li><a href="{{$wikiUrl}}/wiki/Grandes cultures" title="Feldfrüchte">Feldfrüchte</a></li>
...
<div class="col-xl-2 col-lg-6">
<p class="footer-title">Themen</p>
<ul class="list-unstyled">
<li><a href="{{$wikiUrl}}/wiki/Agriculture de précision" title="Präzisionslandwirtschaft">Präzisionslandwirtschaft</a></li>
...
<div class="col-xl-2 col-lg-6">
<p class="footer-title">Hergestellt mit ♡ von <a target="_blank" href="https://neayi.com/">Neayi</a></p>
<ul class="list-unstyled">
